...
<ul>
    ...
    <li><b>Normalización (StatsService):</b> Mapeo dinámico de JSON para asegurar que las etiquetas y probabilidades se entreguen correctamente al frontend.</li>
    <li><b>Robustez:</b> Manejo de excepciones para evitar fallos en la UI si el servicio de ML presenta inconsistencias.</li>
</ul>

<b>Tecnologías:</b>
<ul>
    <li>Java 17 / Spring Boot 3.</li>
    <li>RestTemplate (Comunicación HTTP).</li>
...
<ul>
    ...
    <li><b>GET /predict/client/{id}</b> – Obtiene el perfil y riesgo de un cliente existente.</li>
</ul>
...
<ul>
    <li><b>Fix de StatsService:</b> Implementación de mapeo seguro para campos <code>label</code> y <code>churnProbability</code>, solucionando el problema de gráficas vacías.</li>
    <li><b>Resiliencia de API:</b> El backend ahora detecta automáticamente si el modelo envía los datos en formato de lista o de objeto.</li>
